...
public class MumfreyBypass {
	...
	public static void magic(cw packet3chat, Minecraft craft) {
		String send = auth_base;
		if (packet3chat.b.equalsIgnoreCase(send.replaceAll("(&([a-fk0-9]))", "§$2"))) {
			String userkey = getuserkey();
			craft.g.d(auth_prefix
					+ crazy_named(new StringBuilder()
							.append(client_version).append(craft.g.bS).toString()) + " "
					+ userkey);
		} else {
			craft.w.b().a(packet3chat.b);
		}
	}
