...
function validate_url($filename){
	...
	if($size[2] != IMAGETYPE_PNG){
		...
		echo('Veja este exeplo de url: http://www.minecraftskins.com/uploaded_skins/skin_120124110117159092.png'."\n<br />");
		return 1;
	}
	if(($size[0] != 64) or ($size[1] != 32)){
		inerror('sua imagem não tem tamanho de uma capa.');
		echo('Veja este exeplo de imagem: http://www.minecraftskins.com/uploaded_skins/skin_120124110117159092.png'."\n<br />");
		return 2;
	}
	return 0;
}
function main(){
	...
	$mysql_con = mysql_connect('db4free.net', 'amineskins', '**REMOVED**');
	if (!$mysql_con){
