...
public class Host
{
    ...
    {
        nativeState = create((address != null ? addressToInt(address.getAddress()) : 0), (address != null ? address.getPort() : 0), peerCount, channelLimit, incomingBandwidth, outgoingBandwidth);
    }
