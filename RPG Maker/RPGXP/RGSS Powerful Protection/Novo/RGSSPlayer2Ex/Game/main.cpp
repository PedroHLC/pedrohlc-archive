...
static const wchar_t*	pWndClassName	= L"RGSS2 Player";

static const wchar_t*	pDefaultLibrary	= L"rgss2.dll";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	typedef void		(*RGSSInitialize2)(HMODULE hRgssDll);
	...
	RGSSInitialize2		pRGSSInitialize2	= NULL;
