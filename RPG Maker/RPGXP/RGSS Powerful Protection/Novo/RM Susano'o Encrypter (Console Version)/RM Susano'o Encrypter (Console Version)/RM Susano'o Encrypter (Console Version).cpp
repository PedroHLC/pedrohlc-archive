...
int password_create(){
	...
	while(true){
		dprintf("[Type anything you want with 3 or more letters] Digite uma senha(tamanho de 3 caracteres): ");
		fflush(stdin);
		scanf("%s", &noobpass);
