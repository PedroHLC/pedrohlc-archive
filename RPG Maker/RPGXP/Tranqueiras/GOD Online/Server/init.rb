...
load "./Config.cfg"
load "./GlobalEvents.rb"
load './Client_Regular.rb'
load './Server.rb'
 
$log = {}
$log['error'] = "./Debug/ERROR.txt"
$log['socket'] = "./Debug/SOCKET.txt"
$log['messages'] = "./Debug/MSGLOG.txt"
$log['server'] = "./Debug/SERVER.txt"
$log['neo_puts'] = "./Debug/PUTS.txt"
$log['chat'] = "./Debug/CHAT.txt"
...
class MainWindow < Gtk::Window
  ...
  def rewrite_configs
    ...
    file.write("$EVENTS_PORT = #{@port_input.text.to_i+1}")
    file.close
